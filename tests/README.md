...
| **Namespace / JSON / lib** | **`namespace.test.ts`**, **`json-text.test.ts`**, **`resource-facade.test.ts`**, **`truncate-tool-description.test.ts`**, **`with-timeout.test.ts`**, **`error-message.test.ts`**, **`fetch-timeout.test.ts`** |
